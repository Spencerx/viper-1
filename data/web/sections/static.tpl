<div class="tab-pane active" id="static">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <th></th>
            <td><a class="btn btn-danger btn-small" href="/delete/{{file_info[8]}}">Delete</a> <a class="btn btn-primary btn-small" href="/get/{{project}}/{{file_info[8]}}">Download</a> <a class="btn btn-primary btn-small" onClick="$('#cuckoo').load('/cuckoo/submit?hash={{file_info[8]}}&amp;project={{project}}');">Cuckoo</a> <span id="cuckoo"></span></td>
        </tr>
    </table>
